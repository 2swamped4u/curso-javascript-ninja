...
console.log(convertToHex('green')) //O hexadecimal para a cor blue é #008000.
console.log(convertToHex('yellow')) //O hexadecimal para a cor blue é #FFFF00.
console.log(convertToHex('black')) //O hexadecimal para a cor blue é é#000000.
